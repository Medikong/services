# Idle benchmark 분석: idle-20260722T112200Z-cd9425
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| user-service | 36 | 0.000% | 0.000% | 9.23 MiB | 16.62 MiB | 20.16 MiB |
...
- 앱 메모리 평균이 가장 큰 서비스는 `user-service`이며 9.23 MiB다.
- 앱 CPU 평균이 가장 큰 서비스는 `user-service`이며 0.000%다.
