module github.com/Medikong/services/services/go-reference-service

go 1.26

require (
	github.com/Medikong/services/packages/go-audit v0.0.0
...
replace github.com/Medikong/services/packages/go-audit => ../../packages/go-audit

replace github.com/Medikong/services/packages/go-authz => ../../packages/go-authz

replace github.com/Medikong/services/packages/go-contracts => ../../packages/go-contracts

replace github.com/Medikong/services/packages/go-platform => ../../packages/go-platform
