...
func NewRegistration(credentials *httpauth.Credentials, csrf *httputil.CSRF, service *applicationregistration.Service) *RegistrationController {
...
func (c *RegistrationController) Start(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.Start(r.Context(), applicationregistration.StartInput{
...
func (c *RegistrationController) IssueChallenge(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.IssueChallenge(r.Context(), applicationregistration.IssueChallengeInput{
...
func (c *RegistrationController) VerifyChallenge(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.VerifyChallenge(r.Context(), applicationregistration.VerifyChallengeInput{
...
func (c *RegistrationController) Complete(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.Complete(r.Context(), applicationregistration.CompleteInput{
...
func (c *RegistrationController) Status(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.service.Status(r.Context(), applicationregistration.StatusInput{
