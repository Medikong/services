...
type SessionController struct {
	...
	csrf        *httputil.CSRF
	service     *applicationsession.Service
}

func NewSession(credentials *httpauth.Credentials, csrf *httputil.CSRF, service *applicationsession.Service) *SessionController {
