// Package outboxrelay owns the at-least-once side of auth domain-event
...
func New(repository outbox.Repository, publisher Publisher, config Config) (*Service, error) {
