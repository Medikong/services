...
def resources_from_env() -> AppResources:
    ...
    if database_url == "":
        ...
        return AppResources(
            ...
            counter_repository=DropInterestCounterStore(),
            view_repository=view_store,
            view_ranking_repository=DropViewRankingStore(view_store),
    ...
    return AppResources(
        ...
        view_ranking_repository=PostgresDropViewRankingRepository(session_factory),
        event_publisher=event_publisher,
        engine=engine,
        kafka_publisher=kafka_runtime.publisher,
    )
