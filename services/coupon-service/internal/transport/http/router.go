...
var operationCatalog = []Operation{
	...
	{ID: "API.A.19-10", CommandID: "CMD.A.19-01", Method: http.MethodPost, Path: "/api/v1/internal/coupon-campaigns", Group: GroupCampaign, Boundary: httpcontract.BoundaryWorkload, Command: true, ApprovalRequired: true, BodySchema: "CreateCouponCampaignRequest", ResponseSchema: "CampaignResponse", SuccessStatus: http.StatusCreated, LocationHeader: true},
	...
	{ID: "API.A.19-16", Method: http.MethodGet, Path: "/api/v1/internal/coupon-campaigns/{campaignId}/performance", Group: GroupCampaign, Boundary: httpcontract.BoundaryWorkload, QueryParameters: []string{"from", "to"}, ResponseSchema: "CampaignPerformanceResponse", SuccessStatus: http.StatusOK},
	...
	{ID: "API.A.19-23", CommandID: "CMD.A.19-13", Method: http.MethodPost, Path: "/api/v1/internal/compensation-coupon-issue-requests", Group: GroupIssuance, Boundary: httpcontract.BoundaryWorkload, Command: true, ApprovalRequired: true, CaseRequired: true, BodySchema: "CreateCompensationIssueRequest", ResponseSchema: "IssueAcceptedResponse", SuccessStatus: http.StatusAccepted, LocationHeader: true, RetryAfterHeader: true},
